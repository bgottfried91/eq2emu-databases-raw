...
--
-- Table structure for table `character_quest_progress`
--
...
) ENGINE=InnoDB AUTO_INCREMENT=161298 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
...
-- (data omitted for character_quest_progress)
ALTER TABLE `character_quest_progress` AUTO_INCREMENT = 1;
