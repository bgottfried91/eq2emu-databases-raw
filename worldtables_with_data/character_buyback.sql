...
--
-- Table structure for table `character_buyback`
--
...
) ENGINE=InnoDB AUTO_INCREMENT=23368 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
...
-- (data omitted for character_buyback)
ALTER TABLE `character_buyback` AUTO_INCREMENT = 1;
