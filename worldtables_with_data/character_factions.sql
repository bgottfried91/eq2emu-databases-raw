...
--
-- Table structure for table `character_factions`
--
...
) ENGINE=InnoDB AUTO_INCREMENT=8087753 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
...
-- (data omitted for character_factions)
ALTER TABLE `character_factions` AUTO_INCREMENT = 1;
