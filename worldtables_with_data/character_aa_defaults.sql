...
--
-- Table structure for table `character_aa_defaults`
--
...
--
-- Dumping data for table `character_aa_defaults`
--

LOCK TABLES `character_aa_defaults` WRITE;
/*!40000 ALTER TABLE `character_aa_defaults` DISABLE KEYS */;
/*!40000 ALTER TABLE `character_aa_defaults` ENABLE KEYS */;
UNLOCK TABLES;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
