...
--
-- Table structure for table `spawn_ground_houses`
--

DROP TABLE IF EXISTS `spawn_ground_houses`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `spawn_ground_houses` (
...
-- (data omitted for spawn_ground_houses)
ALTER TABLE `spawn_ground_houses` AUTO_INCREMENT = 1;
