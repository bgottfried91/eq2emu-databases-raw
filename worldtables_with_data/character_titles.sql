...
) ENGINE=InnoDB AUTO_INCREMENT=11708 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
...
-- (data omitted for character_titles)
ALTER TABLE `character_titles` AUTO_INCREMENT = 1;
