...
--
-- Table structure for table `spawn_signs_houses`
--

DROP TABLE IF EXISTS `spawn_signs_houses`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `spawn_signs_houses` (
...
-- (data omitted for spawn_signs_houses)
ALTER TABLE `spawn_signs_houses` AUTO_INCREMENT = 1;
