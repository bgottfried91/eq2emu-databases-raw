...
--
-- Table structure for table `character_skillbar`
--
...
) ENGINE=InnoDB AUTO_INCREMENT=62506 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
...
-- (data omitted for character_skillbar)
ALTER TABLE `character_skillbar` AUTO_INCREMENT = 1;
