...
) ENGINE=InnoDB AUTO_INCREMENT=23685944 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
...
-- (data omitted for character_items)
ALTER TABLE `character_items` AUTO_INCREMENT = 1;
