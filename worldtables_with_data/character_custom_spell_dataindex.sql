-- Table: `character_custom_spell_dataindex`
USE `eq2emu`;
...
--
-- Table structure for table `character_custom_spell_dataindex`
--
...
-- (data omitted for character_custom_spell_dataindex)
ALTER TABLE `character_custom_spell_dataindex` AUTO_INCREMENT = 1;
