...
) ENGINE=InnoDB AUTO_INCREMENT=3034 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
...
-- (data omitted for character_instances)
ALTER TABLE `character_instances` AUTO_INCREMENT = 1;
