...
--
-- Table structure for table `character_collections`
--
...
) ENGINE=InnoDB AUTO_INCREMENT=7934 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
...
-- (data omitted for character_collections)
ALTER TABLE `character_collections` AUTO_INCREMENT = 1;
