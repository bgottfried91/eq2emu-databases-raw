...
--
-- Table structure for table `character_spell_effect_targets`
--
...
-- (data omitted for character_spell_effect_targets)
ALTER TABLE `character_spell_effect_targets` AUTO_INCREMENT = 1;
