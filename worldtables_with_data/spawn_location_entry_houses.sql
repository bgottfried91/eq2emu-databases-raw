-- Table: `spawn_location_entry_houses`
USE `eq2emu`;
...
--
-- Table structure for table `spawn_location_entry_houses`
--

DROP TABLE IF EXISTS `spawn_location_entry_houses`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `spawn_location_entry_houses` (
...
-- Dump completed on 2025-09-27  0:00:41

-- (data omitted for spawn_location_entry_houses)
ALTER TABLE `spawn_location_entry_houses` AUTO_INCREMENT = 1;
