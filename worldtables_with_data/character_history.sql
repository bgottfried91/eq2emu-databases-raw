...
) ENGINE=InnoDB AUTO_INCREMENT=2208083 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
...
-- (data omitted for character_history)
ALTER TABLE `character_history` AUTO_INCREMENT = 1;
