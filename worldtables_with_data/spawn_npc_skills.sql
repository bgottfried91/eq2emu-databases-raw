...
--
-- Table structure for table `spawn_npc_skills`
--
...
--
-- Dumping data for table `spawn_npc_skills`
--

LOCK TABLES `spawn_npc_skills` WRITE;
/*!40000 ALTER TABLE `spawn_npc_skills` DISABLE KEYS */;
/*!40000 ALTER TABLE `spawn_npc_skills` ENABLE KEYS */;
UNLOCK TABLES;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
