...
--
-- Table structure for table `character_achievements_items`
--
...
-- (data omitted for character_achievements_items)
ALTER TABLE `character_achievements_items` AUTO_INCREMENT = 1;
