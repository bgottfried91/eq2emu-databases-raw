...
) ENGINE=InnoDB AUTO_INCREMENT=2969285 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
...
-- (data omitted for character_spells)
ALTER TABLE `character_spells` AUTO_INCREMENT = 1;
