...
--
-- Table structure for table `character_items_group_members`
--
...
-- (data omitted for character_items_group_members)
ALTER TABLE `character_items_group_members` AUTO_INCREMENT = 1;
