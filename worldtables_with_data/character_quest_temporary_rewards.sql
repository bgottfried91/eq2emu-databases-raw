...
--
-- Table structure for table `character_quest_temporary_rewards`
--
...
-- (data omitted for character_quest_temporary_rewards)
ALTER TABLE `character_quest_temporary_rewards` AUTO_INCREMENT = 1;
