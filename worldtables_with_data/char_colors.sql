...
--
-- Table structure for table `char_colors`
--
...
) ENGINE=InnoDB AUTO_INCREMENT=150549 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
...
-- (data omitted for char_colors)
ALTER TABLE `char_colors` AUTO_INCREMENT = 1;
