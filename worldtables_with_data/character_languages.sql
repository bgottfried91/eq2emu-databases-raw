...
) ENGINE=InnoDB AUTO_INCREMENT=2399 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
...
-- (data omitted for character_languages)
ALTER TABLE `character_languages` AUTO_INCREMENT = 1;
