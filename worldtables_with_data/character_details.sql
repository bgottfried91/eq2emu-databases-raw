...
) ENGINE=InnoDB AUTO_INCREMENT=4052 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
...
-- (data omitted for character_details)
ALTER TABLE `character_details` AUTO_INCREMENT = 1;
