...
) ENGINE=InnoDB AUTO_INCREMENT=19094 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
...
-- (data omitted for character_recipes)
ALTER TABLE `character_recipes` AUTO_INCREMENT = 1;
