-- Table: `character_custom_spell_data`
USE `eq2emu`;
...
--
-- Table structure for table `character_custom_spell_data`
--
...
-- (data omitted for character_custom_spell_data)
ALTER TABLE `character_custom_spell_data` AUTO_INCREMENT = 1;
