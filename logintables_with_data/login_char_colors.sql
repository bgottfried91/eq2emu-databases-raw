...
) ENGINE=MyISAM AUTO_INCREMENT=137199 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
...
-- (data omitted for login_char_colors)
ALTER TABLE `login_char_colors` AUTO_INCREMENT = 1;
